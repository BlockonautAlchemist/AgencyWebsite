    ...
    return (
        <div className="bg-darkblue -mt-40">
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4 md:col-span-4 lg:col-span-4'>
                        <div className="flex gap-2">
                            ...
                            <h5 className="text-base font-normal text-white/90">925 Filbert Street Pennsylvania 18072</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/telephone.svg'} alt="telephone-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-white/90">+ 45 34 11 44 11</h5>
                        </div>
                        <div className="flex gap-2 mt-10">
                            <Image src={'/assets/footer/email.svg'} alt="email-icon" width={24} height={24} />
                            <h5 className="text-base font-normal text-white/90">info@gmail.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-white/20'>
                    <h4 className='text-white/80 text-sm text-center lg:text-start font-normal'>@2023 Agency. All Rights Reserved by <Link href="https://adminmart.com/" target="_blank" className="text-white/90 hover:text-white transition-colors"> Adminmart.com</Link></h4>
                    <div className="flex gap-5 mt-5 lg:mt-0 justify-center lg:justify-start">
                        <h4 className='text-white/80 text-sm font-normal'><Link href="/" target="_blank" className="hover:text-white transition-colors">Privacy policy</Link></h4>
                        <div className="h-5 bg-white/30 w-0.5"></div>
                        <h4 className='text-white/80 text-sm font-normal'><Link href="/" target="_blank" className="hover:text-white transition-colors">Terms & conditions</Link></h4>
                    </div>
                </div>
