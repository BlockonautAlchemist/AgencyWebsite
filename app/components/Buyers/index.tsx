            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-5'>
                {cardData.map((items, i) => (
                    <div className='flex flex-col justify-center items-center' key={i}>
                        ...
                        <h2 className='text-4xl lg:text-6xl text-navyblue font-semibold text-center mt-5'>{items.percent}</h2>
                        <h3 className='text-2xl text-navyblue font-semibold text-center lg:mt-6'>{items.heading}</h3>
